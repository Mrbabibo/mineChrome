...
export default {
  ...
  methods: {
    ...
    handleRecommendArticle() {
      ...
      const request = ajax({
        method: 'post',
        url: `${BASE_URL}/api/postTab`,
        data: {
          des:this.article.description,
          title: this.article.title,
          keyname: this.article.keyname,
          url: this.article.link,
          icon: this.article.icon || 'https://sitecdn.zcycdn.com/zcy-front-other-upload/bf8efafe88c1931164ca86e538d16c0f.png',
          auth: this.article.reporter,
        },
      });
